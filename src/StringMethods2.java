...
public class StringMethods2 {
	public static void main(String[] args) {
		...
		String wah = ("ClkjhfUJHeuUUUUUUUUUFKjkfdhfkd");
		// 2. Print your String to the console in upper case.
		System.out.println(wah.toUpperCase());
		// 3. Print your String to the console in lower case.
		System.out.println(wah.toLowerCase());
		// 4. Print the first 3 char's of your String
		//    HINT: .substring(start,end)
		System.out.println(wah.substring(0,3));
		// 5. Print a single char somewhere in the middle of your String
		//    REMINDER: char's in string start at index 0
		System.out.println(wah.substring(0,10)+'?'+wah.substring(10,wah.length()));
